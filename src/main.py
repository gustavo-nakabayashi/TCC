...
def main():
    ...
    df_forecast = pd.read_csv("C:\\Users\\gubar\\Documents\\UFMG\\TCC\\previsions\\PETR4_D1_high.csv")
    df_forecast.columns = ["time", "high"]
    df_low = pd.read_csv("C:\\Users\\gubar\\Documents\\UFMG\\TCC\\previsions\\PETR4_D1_low.csv")
    ...
    df_close = pd.read_csv("C:\\Users\\gubar\\Documents\\UFMG\\TCC\\data\\PETR4_M15_close.csv")
